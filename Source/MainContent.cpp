...
void MainContent::resized()
{
  if ( /* global controls */
       ...
       /* main screens */
       this->blank == nullptr || this->config    == nullptr ||
  ...
  this->blank     ->setBounds(bg_x       , bg_y       , bg_w        , bg_h      ) ;
                              ...
                              Value     linjam_status                             )
{
  ...
  // show spinner
  this->blank->progressBar ->setVisible(true) ;
  this->blank->spinnerLabel->setVisible(true) ;
