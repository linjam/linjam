...
Channel::Channel (ValueTree channel_store)
{
    ...
    xmitButton->setBounds (2, 4, 48, 16);
    ...
    muteButton->setBounds (2, 20, 48, 16);
    ...
    soloButton->setBounds (2, 36, 48, 16);
    ...
    removeButton->setBounds (53, 4, 15, 16);
    ...
    configButton->setBounds (53, 20, 15, 16);
    ...
    panSlider->setBounds (18, 50, 36, 36);
    ...
    stereoLabel->setBounds (18, 70, 36, 12);
    ...
    vuLeftSlider->setBounds (12, 88, 16, 128);
    ...
    vuRightSlider->setBounds (44, 88, 16, 128);

    vuLeftLabel.reset (new juce::Label ("vuLeftLabel",
                                        TRANS ("-120")));
    addAndMakeVisible (vuLeftLabel.get());
    vuLeftLabel->setFont (juce::Font (16.00f, juce::Font::plain).withTypefaceStyle ("Bold"));
    ...
    vuLeftLabel->setBounds (4, 220, 32, 12);

    vuRightLabel.reset (new juce::Label ("vuRightLabel",
                                         TRANS ("-120")));
    addAndMakeVisible (vuRightLabel.get());
    vuRightLabel->setFont (juce::Font (16.00f, juce::Font::plain).withTypefaceStyle ("Bold"));
    ...
    vuRightLabel->setBounds (36, 220, 32, 12);
    ...
    gainSlider->setBounds (24, 88, 24, 128);

    nameLabel.reset (new juce::Label ("nameLabel",
                                      TRANS ("Metronome")));
    addAndMakeVisible (nameLabel.get());
    nameLabel->setExplicitFocusOrder (8);
    nameLabel->setFont (juce::Font (16.00f, juce::Font::plain).withTypefaceStyle ("Regular"));
    ...
    nameLabel->setBounds (0, 232, 72, 16);
...
void Channel::resized()
{
  ...
  // per stereo/mono, show/hide right VU, shrink/expand left VU, shifting gain sliders
  ...
  bool is_wider  = is_mono && ! is_master ; // ie: right VU hidden
  int  vu_w      = ( (is_wider) ? GUI::VU_LG_W     : GUI::VU_SM_W ) ;
  int  gain_x    = ( (is_wider) ? GUI::VU_LG_W + 2 : GUI::PAD2    ) + GUI::VU_X + GUI::PAD ;
  int  label_x   = ( (is_wider) ? GUI::VU_X        : GUI::PAD2    ) - GUI::PAD ;
  int  label_y   = this->vuLeftLabel ->getY() ;
  int  slider_h  = this->vuLeftSlider->getHeight() ;

  this->vuLeftSlider->setSize           (vu_w    , slider_h ) ;
  this->gainSlider  ->setTopLeftPosition(gain_x  , GUI::VU_Y) ;
  this->vuLeftLabel ->setTopLeftPosition(label_x , label_y  ) ;
...
void Channel::updateVU(Slider* a_vu_slider , Label* a_vu_label , Value vu_var)
{
  ...
  bool   is_in_range    = (vu_value >  GUI::VU_DB_MIN && vu_value <= GUI::VU_DB_RANGE) ;
  bool   is_saturated   = actual_vu >=            0.0 && ! is_metro ;
  String label_text     = (is_in_range ) ? String(int(actual_vu)) : GUI::INFINITY_CHAR ;
  Colour thumb_color    = (is_saturated) ? Colour(0xFFFF0000)     : Colour(0xFFBBBBFF) ;
  Colour track_color    = (is_saturated) ? Colour(0x80800000)     : Colour(0x80008000) ;
  Colour label_fg_color = (is_in_range ) ? Colour(0xFF008000)     :
                          (is_saturated) ? Colour(0xFFFF0000)     : Colour(0xFFFFFFFF) ;
  Colour label_bg_color = (is_saturated) ? Colour(0xFFFF0000)     : Colour(0x00000000) ;

  a_vu_slider->setValue (vu_value) ;
  a_vu_label ->setText  (label_text , dontSendNotification) ;
  a_vu_slider->setColour(Slider::thumbColourId  , thumb_color   ) ;
  a_vu_slider->setColour(Slider::trackColourId  , track_color   ) ;
  a_vu_label ->setColour(Label::textColourId    , label_fg_color) ;
  a_vu_label ->setColour(Label::outlineColourId , label_bg_color) ;
}
...
<JUCER_COMPONENT documentType="Component" className="Channel" componentName="Channel"
                 ...
                 fixedSize="0" initialWidth="72" initialHeight="252">
  ...
  <TOGGLEBUTTON name="xmitButton" id="f45f759640162c62" memberName="xmitButton"
                virtualName="" explicitFocusOrder="1" pos="2 4 48 16" txtcol="ff808080"
  ...
  <TOGGLEBUTTON name="muteButton" id="263020526add917" memberName="muteButton"
                virtualName="" explicitFocusOrder="2" pos="2 20 48 16" txtcol="ff808080"
  ...
  <TOGGLEBUTTON name="soloButton" id="3b096c8c7df5c792" memberName="soloButton"
                virtualName="" explicitFocusOrder="3" pos="2 36 48 16" txtcol="ff808080"
  ...
  <TEXTBUTTON name="removeButton" id="becd368b728d32c0" memberName="removeButton"
              virtualName="" explicitFocusOrder="4" pos="53 4 15 16" bgColOff="ff400000"
  ...
  <TEXTBUTTON name="configButton" id="f0a56a4ebe614916" memberName="configButton"
              virtualName="" explicitFocusOrder="5" pos="53 20 15 16" bgColOff="ff404000"
  ...
  <SLIDER name="panSlider" id="aa7c4f80abb603e9" memberName="panSlider"
          virtualName="" explicitFocusOrder="6" pos="18 50 36 36" textboxtext="ff808080"
  ...
  <LABEL name="stereoLabel" id="deaf84482cab9f7d" memberName="stereoLabel"
         virtualName="" explicitFocusOrder="0" pos="18 70 36 12" textCol="ff008000"
  ...
  <SLIDER name="vuLeftSlider" id="fbb656fdc87f46ed" memberName="vuLeftSlider"
          virtualName="" explicitFocusOrder="0" pos="12 88 16 128" textboxtext="ff808080"
  ...
  <SLIDER name="vuRightSlider" id="31c942b6caa362dd" memberName="vuRightSlider"
          virtualName="" explicitFocusOrder="0" pos="44 88 16 128" textboxtext="ff808080"
          textboxbkgd="0" min="-120.0" max="20.0" int="0.0" style="LinearBar"
          textBoxPos="NoTextBox" textBoxEditable="0" textBoxWidth="48"
          textBoxHeight="12" skewFactor="1.0" needsCallback="1"/>
  <LABEL name="vuLeftLabel" id="cdc1fb3056af7c9b" memberName="vuLeftLabel"
         virtualName="" explicitFocusOrder="0" pos="4 220 32 12" textCol="ff808080"
         edTextCol="ff000000" edBkgCol="0" labelText="-120" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="16.0" kerning="0.0" bold="1" italic="0" justification="36"
         typefaceStyle="Bold"/>
  <LABEL name="vuRightLabel" id="4bb31261e6795ae1" memberName="vuRightLabel"
         virtualName="" explicitFocusOrder="0" pos="36 220 32 12" textCol="ff808080"
         edTextCol="ff000000" edBkgCol="0" labelText="-120" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="16.0" kerning="0.0" bold="1" italic="0" justification="36"
         typefaceStyle="Bold"/>
  <SLIDER name="gainSlider" id="e34ef13291b2ec40" memberName="gainSlider"
          virtualName="" explicitFocusOrder="7" pos="24 88 24 128" textboxtext="ff808080"
  ...
  <LABEL name="nameLabel" id="66bafa468220da02" memberName="nameLabel"
         virtualName="" explicitFocusOrder="8" pos="0 232 72 16" textCol="ff808080"
         edTextCol="ff000000" edBkgCol="0" labelText="Metronome" editableSingleClick="1"
